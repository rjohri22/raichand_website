                ...
                <div class="white-box">
                    <div class="row">
                        ...
                        <div class="col-md-6" align="right">
                            <a href="categories_list.php"><button type="button" class="btn btn-dark">All CATEGORIES</button></a>
                    ...
                    <div class="table-responsive">
                        <table class="table text-nowrap">
                            ...
                            <tr>
                                ...
                                <td><a class="btn btn-warning text-white" href="edit.php?id=<?php echo $row['id']; ?>">Edit</a>
                                <a class="btn btn-warning" onclick="return confirm('are you sure?')" href="delete.php?id=<?php echo $row['id']; ?>">Delete</a></td></tr>
                            <?php
                            }
                            } 
                            ?>
